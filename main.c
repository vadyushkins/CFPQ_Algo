...
char GRAPH_INPUT_FILE[MAX_COMMAND_LINE_ITEM_NAME_LEN];
char GRAMMAR_INPUT_FILE[MAX_COMMAND_LINE_ITEM_NAME_LEN];
char QUERIES_INPUT_FILE[MAX_COMMAND_LINE_ITEM_NAME_LEN];
int PRINT_TIME = 0;
